...
1. Download the SKILL.md file from the skills/ folder
2. Review and configure the skill to your needs (Tip: Ask Claude for support here)
3. Upload it to Claude following the instructions in Claude's support docs (Using skills in Claude)
4. The skill will be available in any new conversation

For details on connecting Crossbeam to Claude, review our help documentation here.
